...
public class PassportAPIPage extends PassportPageObject {
    ...
    public void getRequestToJwksEndpointDev() throws IOException, InterruptedException {
    ...
    public void getRequestToJwksEndpointBuildAndStaging() throws IOException, InterruptedException {
        String publicApiGatewayUrl = configurationService.getPublicAPIEndpoint();
        LOGGER.info("getPrivateAPIEndpoint() ==> {}", publicApiGatewayUrl);
        HttpRequest request =
                HttpRequest.newBuilder()
    ...
    public void postRequestToAccessTokenEndpointTest(String endpoint, String criId)
            throws IOException, InterruptedException {
        String publicApiGatewayUrl = configurationService.getPublicAPIEndpoint();
        LOGGER.info("getPublicAPIEndpoint() ==> " + publicApiGatewayUrl);
        HttpRequest request =
