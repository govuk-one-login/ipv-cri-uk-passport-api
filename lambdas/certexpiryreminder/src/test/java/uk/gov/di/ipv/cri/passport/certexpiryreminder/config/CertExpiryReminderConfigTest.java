...
class CertExpiryReminderConfigTest {
    ...
    void shouldReturnMapOfCerts() {
        ...
        when(mockParameterStoreService.getParameterValue(HMPO_HTTPCLIENT_TLS_CERT))
                .thenReturn(TEST_CERT);

        when(mockParameterStoreService.getParameterValue(HMPO_HTTPCLIENT_TLS_INTER_CERT))
                .thenReturn(TEST_CERT);

        when(mockParameterStoreService.getParameterValue(HMPO_HTTPCLIENT_TLS_ROOT_CERT))
                .thenReturn(TEST_CERT);
