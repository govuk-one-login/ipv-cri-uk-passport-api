...
class KmsRsaDecrypterIT {
    private static PassportConfigurationService passportConfigurationService;

    @BeforeAll
    public static void setup() {
        passportConfigurationService = new PassportConfigurationService();
    }
    ...
    void decryptWithKms() throws Exception {
        ...
        String kmsId = passportConfigurationService.getSsmParameter(JAR_ENCRYPTION_KEY_ID);
        String pubKey = passportConfigurationService.getSsmParameter(JAR_KMS_PUBLIC_KEY);
