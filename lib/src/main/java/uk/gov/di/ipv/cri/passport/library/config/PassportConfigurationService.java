...
import static uk.gov.di.ipv.cri.passport.library.config.ConfigurationVariable.MAX_JWT_TTL_UNIT;
...
public class PassportConfigurationService {
    ...
    public long getVcExpiryTime() throws UnknownClientException {
        ChronoUnit jwtTtlUnit = ChronoUnit.valueOf(getSsmParameter(MAX_JWT_TTL_UNIT));
        long ttl = Long.parseLong(getSsmParameter(MAX_JWT_TTL));
