...
public class JarValidator {
    ...
    private JWTClaimsSet getValidatedClaimSet(SignedJWT signedJWT, String clientId)
        ...
        String criAudience =
                passportConfigurationService.getSsmParameter(PASSPORT_CRI_CLIENT_AUDIENCE);
    ...
    private void validateMaxAllowedJarTtl(JWTClaimsSet claimsSet) throws JarValidationException {
        String maxAllowedTtl = passportConfigurationService.getSsmParameter(SESSION_TTL);
